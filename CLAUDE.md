...
| Deployment skeleton | **Increment A live** — dev.oddssea.xyz, keyless CI/CD proven. **Increment B built** (Cognito login on auth.oddssea.xyz, PKCE, 18+ gate, `decisions/0017`) — **first deploy pending**; C (API) next; walkthrough in `infra/README.md` |
