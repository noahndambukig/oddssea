...
| Tasks milestone | **Built, awaiting deploy + production suite** — the faucet: first-bet-of-day, 2-challenge shared stateless draw (`available_from`-frozen), consistency + volume weeklies, 3-step tour chain, first dice bet (`decisions/0024` — interim ≈2,575/wk vs spec 3,400, bust-proof waiver recorded). Zero new tables; progress derived, never stored; numbers via `docs/01-game/data/tasks.json`. Draw harness 10/10. Walkthrough Part 10 |
